...
async def get_video_data(url, search, bettersearch, loop):
    ...
    if not search and not bettersearch:
        ...
        if bettersearch:
            ...
            ytdl = yt_dlp.YoutubeDL({"format": "bestaudio/best", "restrictfilenames": True, "noplaylist": True, "nocheckcertificate": True,
...
class MusicPlayer(object):
    ...
    async def queue(self, url, search=False, bettersearch=True):
